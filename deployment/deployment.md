...
Les scripts [remix_compile.js](remix_compile.js) et [remix_deploy.js](remix_deploy.js) (à placer dans le dossier `scripts` du workspace Remix, puis à lancer l'un après l'autre via clique droit > "Run") permettent de recompiler puis redéployer le contrat sans repasser par l'interface manuelle — pratique car l'environnement "Remix VM" ne conserve pas les contrats déployés d'une session à l'autre.
